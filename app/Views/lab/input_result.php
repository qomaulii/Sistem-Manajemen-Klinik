...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <p>
            ...
            <strong>Tes Lab:</strong> <?= esc($request->test_name ?: '-') ?><br>
        ...
        <?= form_open($formAction) ?>
            ...
            <div class="form-group">
                ...
                <small class="text-muted">
                    Bisa diisi nomor hasil, catatan bukti pemeriksaan, atau keterangan file hasil lab.
                </small>
            </div>

            <button type="submit" class="btn btn-primary"><?= esc($buttonText) ?></button>
            <a href="<?= base_url('test/queue') ?>" class="btn btn-default">Kembali</a>
        <?= form_close() ?>
    </div>
</div>