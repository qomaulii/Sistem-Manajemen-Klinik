...
<div class="panel panel-info">
    <div class="panel-heading">Daftar Antrean Pasien X-Ray</div>
                ...
                <?php if (!empty($requests)) : ?>
                    <?php foreach ($requests as $r) : ?>
                        ...
                        <tr>
                            ...
                            <td><?= esc($r->xray_name ?: '-') ?></td>
                            <td><?= esc($r->doctor_notes ?: '-') ?></td>
                            <td><span class="label label-warning">Menunggu</span></td>
                            <td>
                                <a href="<?= base_url('xray/input_result/' . $r->request_id) ?>" class="btn btn-primary btn-sm">
                                    Input Hasil
                                </a>
                            </td>
                        </tr>
                ...
                <?php else : ?>
                    <tr>
                        <td colspan="7" class="text-center text-muted">
                            Belum ada pasien yang menunggu hasil x-ray.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
