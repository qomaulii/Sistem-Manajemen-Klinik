  ...
  <div class="panel-heading">
    <h4 class="panel-title">
      <a href="#collapseXray" data-parent="#accordion" data-toggle="collapse">
        <span class="glyphicon glyphicon-picture"></span> Menu Radiografer
      </a>
    </h4>
  </div>

  <div class="panel-collapse collapse in" id="collapseXray">
        ...
        <tbody>
          <tr>
            <td style="padding: 10px 15px;">
              ...
              <a href="<?= base_url('xray/queue') ?>">Daftar Antrean Pasien</a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 10px 15px;">
              ...
              <a href="<?= base_url('xray/results') ?>">Lihat Daftar X-Ray</a>
            </td>
          </tr>
